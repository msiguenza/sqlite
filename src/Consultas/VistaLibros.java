...
public class VistaLibros extends JDialog
{
	...
	protected void btnCancelar()
	{
        ...
        public void FiltrarBusqueda(){
			...
			ResultSet resulSql=sql.executeQuery("select * from libros where titulo like '%"+textBusqueda.getText()+"%'");
			DefaultTableModel m;
			...
			JOptionPane.showMessageDialog(null, "Error al extraer los datos de la tabla");
				...
				try{
			Statement sql=c.getConexion().createStatement();
			ResultSet resulSql=sql.executeQuery("select * from libros where editorial like '%"+textBusqueda.getText()+"%'");
			DefaultTableModel m;
